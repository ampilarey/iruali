...
class AdminController extends Controller
{
    ...
    public function updateSettings(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'contact_phone' => ['nullable', 'string', 'max:30', 'regex:/^\+\d[\d ]{6,20}$/'],
            'company_legal_name' => 'sometimes|nullable|string|max:150',
            'company_trading_name' => 'sometimes|nullable|string|max:100',
            'company_registration_no' => 'sometimes|nullable|string|max:50',
            'company_address' => 'sometimes|nullable|string|max:300',
            'company_postal_address' => 'sometimes|nullable|string|max:300',
            'customer_service_hours' => 'sometimes|nullable|string|max:120',
            'return_window_days' => 'sometimes|required|integer|min:0|max:90',
