...
<div class="max-w-lg mx-auto py-8">
    ...
    <form action="{{ route('admin.vouchers.update', $voucher) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="code" id="code" class="w-full border rounded px-3 py-2" required value="{{ old('code', $voucher->code) }}">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="amount" id="amount" class="w-full border rounded px-3 py-2" step="0.01" required value="{{ old('amount', $voucher->amount) }}">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="min_order" id="min_order" class="w-full border rounded px-3 py-2" step="0.01" value="{{ old('min_order', $voucher->min_order) }}">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="max_uses" id="max_uses" class="w-full border rounded px-3 py-2" value="{{ old('max_uses', $voucher->max_uses) }}">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="valid_from" id="valid_from" class="w-full border rounded px-3 py-2" value="{{ old('valid_from', optional($voucher->valid_from)->format('Y-m-d')) }}">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="valid_until" id="valid_until" class="w-full border rounded px-3 py-2" value="{{ old('valid_until', optional($voucher->valid_until)->format('Y-m-d')) }}">
            @error('valid_until')<p class="text-red-600 text-sm mt-1">{{ $message }}</p>@enderror
        </div>
        <div class="mb-6">
            <label class="inline-flex items-center">
                <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300" {{ old('is_active', $voucher->is_active) ? 'checked' : '' }}>
