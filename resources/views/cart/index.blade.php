                        ...
                        <div class="p-6">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="text-right">
                                    <p class="text-lg font-semibold text-gray-900 force-ltr" dir="ltr">{{ \App\Support\Money::format($item->subtotal) }}</p>
                                    <p class="text-sm text-gray-500 force-ltr" dir="ltr">{{ \App\Support\Money::format($item->price) }} each</p>
                                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium force-ltr" dir="ltr">{{ \App\Support\Money::format(0) }}</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="border-t border-gray-200 pt-3">
                            <div class="flex justify-between">
                                ...
                                <span class="text-lg font-semibold text-primary-600 force-ltr" dir="ltr">{{ \App\Support\Money::format($cart->total - $discount) }}</span>
                            </div>
                        </div>
                    </div>
