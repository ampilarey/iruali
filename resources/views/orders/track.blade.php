    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <form action="{{ route('order.track.submit') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="order_code" id="order_code" class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="{{ __('e.g. ORD-123456') }}">
                @error('order_code')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="mobile" id="mobile" class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="{{ __('e.g. 7xxxxxx') }}">
            </div>
            <div class="mb-6">
                <label for="otp" class="block text-sm font-medium text-gray-700 mb-2">{{ __('OTP') }}</label>
                <input type="text" name="otp" id="otp" class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="{{ __('6-digit code') }}">
                @error('otp')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
