    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <form action="{{ route('order.track.submit') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="order_code" id="order_code" required value="{{ old('order_code') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="{{ __('e.g. ORD-123456') }}">
                @error('order_code')
