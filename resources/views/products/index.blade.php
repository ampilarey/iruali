                        ...
                        <div class="p-3 sm:p-4">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                                <div class="flex items-center space-x-2">
                                    @if($product->is_on_sale)
                                        <span class="text-base sm:text-lg font-bold text-primary-600">ރ{{ number_format($product->final_price, 2) }}</span>
                                        <span class="text-xs sm:text-sm text-gray-500 line-through">ރ{{ number_format($product->price, 2) }}</span>
                                    @else
                                        <span class="text-base sm:text-lg font-bold text-primary-600">ރ{{ number_format($product->price, 2) }}</span>
                                    @endif
                                </div>
