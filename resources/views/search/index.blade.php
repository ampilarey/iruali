...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-gray-900 mb-4">{{ __('Search Products') }}</h1>
            <p class="text-lg text-gray-600">{{ __('Find exactly what you\'re looking for') }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            <form action="{{ route('search') }}" method="GET" class="space-y-6">
                <div>
                    <label for="q" class="block text-sm font-medium text-gray-700 mb-2">{{ __('Search Term') }}</label>
                    <input type="text" 
                           id="q" 
                           name="q" 
                           value="{{ request('q') }}"
                           placeholder="{{ __('Enter product name, description, SKU, or category...') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label for="min_price" class="block text-sm font-medium text-gray-700 mb-2">{{ __('Min Price') }}</label>
                        <input type="number" 
                               id="min_price" 
                               name="min_price" 
                    ...
                    <div>
                        <label for="max_price" class="block text-sm font-medium text-gray-700 mb-2">{{ __('Max Price') }}</label>
                        <input type="number" 
                               id="max_price" 
                               name="max_price" 
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h3 class="text-lg font-medium text-blue-900 mb-3">{{ __('Search Tips') }}</h3>
            <ul class="text-blue-800 space-y-2">
                <li class="flex items-start">
                    ...
                    <span>{{ __('Use specific product names for best results') }}</span>
                </li>
                <li class="flex items-start">
                    <svg class="w-5 h-5 text-blue-600 mr-2 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    <span>{{ __('Try searching by brand or model number') }}</span>
                </li>
                <li class="flex items-start">
                    <svg class="w-5 h-5 text-blue-600 mr-2 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    <span>{{ __('Use category filters to narrow down results') }}</span>
                </li>
                <li class="flex items-start">
                    <svg class="w-5 h-5 text-blue-600 mr-2 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    <span>{{ __('Set price ranges to find products within your budget') }}</span>
                </li>
            </ul>
        </div>
        ...
        <!-- Popular Searches -->
        <div class="mt-8">
            <h3 class="text-lg font-medium text-gray-900 mb-4">{{ __('Popular Searches') }}</h3>
